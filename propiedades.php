...
<head>
  ...
  <style>
    body{font-family:system-ui,Arial,sans-serif;margin:0;padding:0;background:#f9f9fb;color:#333}
    .container{max-width:1000px;margin:auto;padding:20px}
    .card{background:#fff;padding:20px;border-radius:10px;box-shadow:0 2px 6px rgba(0,0,0,0.1)}
    img.main{max-width:100%;border-radius:10px;margin-bottom:20px}
    h1{margin-top:0;color:#00699e}
    .meta{color:#666;font-size:0.9em;margin-bottom:15px}
    .grid{display:grid;grid-template-columns:2fr 1fr;gap:20px}
    .agente{background:#f4f6f9;padding:15px;border-radius:8px}
    .back{display:inline-block;margin-top:20px;color:#00699e;text-decoration:none;font-weight:bold}
  </style>
</head>
<body>
  <div class="container">
